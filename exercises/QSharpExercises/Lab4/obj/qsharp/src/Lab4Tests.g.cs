...
#line 16 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
            {
...
#line 16 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
        ...
        {
#line 17 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
...
#line 24 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
            foreach (var i in new QRange(1L, 10L))
#line hidden
            {
#line 25 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                foreach (var buffer in buffers)
#line hidden
                {
#line hidden
                    {
#line 26 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                        var qubits = Allocate__.Apply(2L);
#line hidden
                        bool __arg1__ = true;
                        try
                        {
#line 27 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                            Microsoft__Quantum__Intrinsic__H.Apply(qubits[0L]);
#line 28 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                            Microsoft__Quantum__Intrinsic__CNOT.Apply((qubits[0L], qubits[1L]));
#line 30 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                            Lab4__Exercise1.Apply((buffer, qubits[0L]));
#line 32 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                            Microsoft__Quantum__Intrinsic__CNOT.Apply((qubits[0L], qubits[1L]));
#line 33 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                            Microsoft__Quantum__Intrinsic__H.Apply(qubits[0L]);
#line 35 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
...
#line 40 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
...
#line 46 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
...
#line hidden
    ...
    [SourceLocation("D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs", OperationFunctor.Body, 53, -1)]
...
#line 53 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
            {
                var sim = new Microsoft.Quantum.Simulation.Simulators.QuantumSimulator();
                if (sim is Microsoft.Quantum.Simulation.Common.SimulatorBase baseSim && this.Output != null)
                {
...
#line 53 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
        ...
        public override Func<QVoid, QVoid> __Body__ => (__in__) =>
        {
#line 54 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
            var buffers = (IQArray<IQArray<Boolean>>)new QArray<IQArray<Boolean>>(new QArray<Boolean>(false, false), new QArray<Boolean>(false, true), new QArray<Boolean>(true, false), new QArray<Boolean>(true, true));
#line 61 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
            foreach (var i in new QRange(1L, 10L))
#line hidden
            {
#line 62 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                foreach (var buffer in buffers)
#line hidden
                {
#line hidden
                    {
#line 63 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                        var qubits = Allocate__.Apply(2L);
#line hidden
                        bool __arg1__ = true;
                        try
                        {
#line 64 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                            Microsoft__Quantum__Intrinsic__H.Apply(qubits[0L]);
#line 65 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                            Microsoft__Quantum__Intrinsic__CNOT.Apply((qubits[0L], qubits[1L]));
#line 66 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                            if (buffer[1L])
                            {
#line 67 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                                Microsoft__Quantum__Intrinsic__X.Apply(qubits[0L]);
                            }

#line 69 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                            if (buffer[0L])
                            {
#line 70 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                                Microsoft__Quantum__Intrinsic__Z.Apply(qubits[0L]);
                            }

#line 73 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                            var result = (IQArray<Boolean>)Lab4__Exercise2.Apply((qubits[0L], qubits[1L]));
#line 75 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                            Microsoft__Quantum__Diagnostics__AllEqualityFactB.Apply((result, buffer, "Exercise 2 result is incorrect."));
#line 81 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4Tests.qs"
                            ResetAll__.Apply(qubits);
                        }
#line hidden
                        catch
