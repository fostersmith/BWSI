...
#line 30 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4.qs"
            if (buffer[0L])
            {
#line 31 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4.qs"
                if (buffer[1L])
                {
#line 32 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4.qs"
                    Microsoft__Quantum__Intrinsic__X.Apply(pairA);
#line 33 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4.qs"
                    Microsoft__Quantum__Intrinsic__Z.Apply(pairA);
                }
                else
                {
#line 35 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4.qs"
                    Microsoft__Quantum__Intrinsic__Z.Apply(pairA);
                }
            }
            else
            {
#line 38 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4.qs"
                if (buffer[1L])
                {
#line 39 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4.qs"
                    Microsoft__Quantum__Intrinsic__X.Apply(pairA);
                }
            }
...
#line hidden
    ...
    [SourceLocation("D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4.qs", OperationFunctor.Body, 65, -1)]
...
#line 66 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4.qs"
            Microsoft__Quantum__Intrinsic__CNOT.Apply((pairA, pairB));
#line 67 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4.qs"
            Microsoft__Quantum__Intrinsic__H.Apply(pairA);
#line 68 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab4\\Lab4.qs"
            return Microsoft__Quantum__Convert__ResultArrayAsBoolArray.Apply(new QArray<Result>(Microsoft__Quantum__Intrinsic__M.Apply(pairA), Microsoft__Quantum__Intrinsic__M.Apply(pairB)));
        }
