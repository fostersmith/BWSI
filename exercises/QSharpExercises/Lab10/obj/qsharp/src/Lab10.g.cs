...
#line 36 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
            Microsoft__Quantum__Intrinsic__CNOT.Apply((original, spares[0L]));
#line 37 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
...
#line hidden
        ...
        {
            var (original,spares) = __in__;
#line 30 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
...
#line hidden
    ...
    [SourceLocation("D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs", OperationFunctor.Body, 63, 99)]
...
#line hidden
            {
#line 69 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
                var a = Allocate__.Apply();
#line hidden
                bool __arg1__ = true;
                try
                {
#line 70 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
                    Microsoft__Quantum__Canon__ApplyToEach.Apply((Microsoft__Quantum__Intrinsic__CNOT.Partial(new Func<Qubit, (Qubit,Qubit)>((__arg2__) => (__arg2__, a))), register.Slice(new QRange(0L, 1L))));
#line 71 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
                    var resulta = Microsoft__Quantum__Intrinsic__M.Apply(a);
#line 72 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
                    Reset__.Apply(a);
#line 73 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
                    Microsoft__Quantum__Canon__ApplyToEach.Apply((Microsoft__Quantum__Intrinsic__CNOT.Partial(new Func<Qubit, (Qubit,Qubit)>((__arg3__) => (__arg3__, a))), new QArray<Qubit>(register[0L], register[2L])));
#line 74 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
                    var resultb = Microsoft__Quantum__Intrinsic__M.Apply(a);
#line 75 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
                    return new QArray<Result>(resulta, resultb);
                }
#line hidden
                catch
                {
...
#line hidden
    ...
    [SourceLocation("D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs", OperationFunctor.Body, 99, -1)]
...
#line 107 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
            var i = (Microsoft__Quantum__Convert__ResultArrayAsInt.Apply(new QArray<Result>(syndromeMeasurement[1L], syndromeMeasurement[0L])) - 1L);
#line 108 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
            Message__.Apply(String.Format("[{0}, {1}]", syndromeMeasurement[0L], syndromeMeasurement[1L]));
#line 109 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
            Message__.Apply(String.Format("Index {0}", i));
#line 110 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
            if ((i > -(1L)))
            {
#line 111 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab10\\Lab10.qs"
                Microsoft__Quantum__Intrinsic__X.Apply(register[(2L - i)]);
            }
