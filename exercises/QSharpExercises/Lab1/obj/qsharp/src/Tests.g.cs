...
#line 15 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
            {
...
#line hidden
            {
#line 16 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                var target = Allocate__.Apply();
#line hidden
                bool __arg1__ = true;
                try
                {
#line 18 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                    Lab1__Exercise1.Apply(target);
#line 20 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                    Microsoft__Quantum__Intrinsic__X.Apply(target);
#line 22 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
...
#line hidden
    ...
    [SourceLocation("D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs", OperationFunctor.Body, 27, 41)]
...
#line 27 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
            {
                var sim = new Microsoft.Quantum.Simulation.Simulators.QuantumSimulator();
                if (sim is Microsoft.Quantum.Simulation.Common.SimulatorBase baseSim && this.Output != null)
                {
...
#line hidden
            {
#line 28 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                var targets = Allocate__.Apply(2L);
#line hidden
                bool __arg1__ = true;
                try
                {
#line 30 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                    Lab1__Exercise2.Apply((targets[0L], targets[1L]));
#line 32 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                    Microsoft__Quantum__Intrinsic__H.Apply(targets[0L]);
#line 33 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                    Microsoft__Quantum__Intrinsic__H.Apply(targets[1L]);
#line 34 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                    Microsoft__Quantum__Intrinsic__X.Apply(targets[1L]);
#line 36 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
...
#line hidden
    ...
    [SourceLocation("D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs", OperationFunctor.Body, 41, 57)]
...
#line 41 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
            {
                var sim = new Microsoft.Quantum.Simulation.Simulators.QuantumSimulator();
                if (sim is Microsoft.Quantum.Simulation.Common.SimulatorBase baseSim && this.Output != null)
                {
...
#line 41 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
        ...
        public override Func<QVoid, QVoid> __Body__ => (__in__) =>
        {
#line 42 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
            foreach (var numQubits in new QRange(3L, 10L))
#line hidden
            {
#line hidden
                {
#line 43 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                    var qubits = Allocate__.Apply(numQubits);
#line hidden
                    bool __arg1__ = true;
                    try
                    {
#line 45 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                        Lab1__Exercise3.Apply(qubits);
#line 47 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                        foreach (var index in new QRange(0L, (numQubits - 1L)))
#line hidden
                        {
#line 48 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
...
#line 51 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
...
#line hidden
    ...
    [SourceLocation("D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs", OperationFunctor.Body, 57, -1)]
...
#line 57 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
            {
                var sim = new Microsoft.Quantum.Simulation.Simulators.QuantumSimulator();
                if (sim is Microsoft.Quantum.Simulation.Common.SimulatorBase baseSim && this.Output != null)
                {
...
#line 57 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
        ...
        public override Func<QVoid, QVoid> __Body__ => (__in__) =>
        {
#line 58 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
            foreach (var i in new QRange(0L, 4L))
#line hidden
            {
#line 59 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                var states = new QArray<Int64>();
#line hidden
                {
#line 60 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                    var qubits = Allocate__.Apply(5L);
#line hidden
                    bool __arg1__ = true;
                    try
                    {
#line 61 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                        foreach (var j in new QRange(0L, 4L))
#line hidden
                        {
#line 62 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                            states = QArray<Int64>.Add(states, new QArray<Int64>(Microsoft__Quantum__Random__DrawRandomInt.Apply((0L, 1L))));
#line 63 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                            if ((states[j] == 1L))
                            {
#line 64 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                                Microsoft__Quantum__Intrinsic__X.Apply(qubits[j]);
                            }
                        }

#line 68 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                        var results = (IQArray<Int64>)Lab1__Exercise4.Apply(qubits);
#line 70 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
                        Microsoft__Quantum__Diagnostics__AllEqualityFactI.Apply((states?.Copy(), results, "Exercise 4 test failed."));
#line 71 "D:\\BWSI\\exercises\\exercises\\QSharpExercises\\Lab1\\Tests.qs"
