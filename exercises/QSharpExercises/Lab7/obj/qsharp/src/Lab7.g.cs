...
#line 31 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
            foreach (var i in new QRange(0L, (input.Length - 1L)))
#line hidden
            {
#line 32 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
...
#line hidden
    ...
    [SourceLocation("D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs", OperationFunctor.Body, 51, 90)]
    public partial class LeftShiftBy1 : Operation<(IQArray<Qubit>,IQArray<Qubit>), QVoid>, ICallable
    {
        ...
        {
            var (input,output) = __in__;
#line 53 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
            foreach (var inputIndex in new QRange(1L, (input.Length - 1L)))
#line hidden
            {
#line 55 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                var outputIndex = (inputIndex - 1L);
#line 56 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
...
#line hidden
    ...
    [SourceLocation("D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs", OperationFunctor.Body, 90, 131)]
...
#line hidden
            {
#line 94 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
...
#line hidden
                    {
#line 95 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                        var target = Allocate__.Apply(input.Length);
#line hidden
                        bool __arg2__ = true;
                        try
                        {
#line 96 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                            foreach (var i in new QRange(0L, (input.Length - 1L)))
#line hidden
                            {
#line 97 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                                if (input[i])
                                {
#line 98 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                                    Microsoft__Quantum__Intrinsic__X.Apply(register[i]);
                                }
                            }

#line 101 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                            op.Apply((register, target));
#line 102 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                            var output = new QArray<Boolean>();
#line 103 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                            foreach (var qubit in target)
#line hidden
                            {
#line 104 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                                output = QArray<Boolean>.Add(output, new QArray<Boolean>((Microsoft__Quantum__Intrinsic__M.Apply(qubit) == Result.One)));
                            }

#line 106 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                            ResetAll__.Apply(register);
#line 107 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                            return output;
                        }
#line hidden
                        catch
...
#line hidden
    ...
    [SourceLocation("D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs", OperationFunctor.Body, 131, 181)]
...
#line hidden
            {
#line 135 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
...
#line hidden
                    {
#line 136 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                        var target = Allocate__.Apply(inputSize);
#line hidden
                        bool __arg2__ = true;
                        try
                        {
#line 137 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                            Microsoft__Quantum__Canon__ApplyToEach.Apply((Microsoft__Quantum__Intrinsic__H, register));
#line 138 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                            op.Apply((register, target));
#line 139 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                            Microsoft__Quantum__Canon__ApplyToEach.Apply((Microsoft__Quantum__Intrinsic__H, register));
#line 140 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                            var output = new QArray<Boolean>();
#line 141 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                            foreach (var qubit in register)
#line hidden
                            {
#line 142 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                                output = QArray<Boolean>.Add(output, new QArray<Boolean>((Microsoft__Quantum__Intrinsic__M.Apply(qubit) == Result.One)));
                            }

#line 144 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                            ResetAll__.Apply(target);
#line 145 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                            return output;
                        }
#line hidden
                        catch
...
#line hidden
    ...
    [SourceLocation("D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs", OperationFunctor.Body, 181, 217)]
    public partial class Challenge1 : Operation<(IQArray<Qubit>,IQArray<Qubit>), QVoid>, ICallable
    {
        ...
        {
            var (input,output) = __in__;
#line 182 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
            foreach (var i in new QRange(0L, (input.Length - 2L)))
#line hidden
            {
#line 183 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
...
#line hidden
    ...
    [SourceLocation("D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs", OperationFunctor.Body, 217, -1)]
...
#line hidden
            {
#line 220 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                var a = Allocate__.Apply();
#line hidden
                bool __arg1__ = true;
                try
                {
#line 221 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                    Microsoft__Quantum__Intrinsic__CNOT.Apply((input[2L], output[1L]));
#line 222 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                    Microsoft__Quantum__Intrinsic__CNOT.Apply((input[0L], a));
#line 223 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                    Microsoft__Quantum__Intrinsic__CNOT.Apply((input[1L], a));
#line 224 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                    Microsoft__Quantum__Intrinsic__CCNOT.Apply((a, output[1L], output[0L]));
#line 225 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                    Microsoft__Quantum__Intrinsic__X.Apply(a);
#line 226 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                    Microsoft__Quantum__Intrinsic__X.Apply(output[1L]);
#line 227 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                    Microsoft__Quantum__Intrinsic__CCNOT.Apply((a, output[1L], output[0L]));
#line 228 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                    Microsoft__Quantum__Intrinsic__CCNOT.Apply((a, output[1L], output[2L]));
#line 229 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                    Microsoft__Quantum__Intrinsic__X.Apply(output[1L]);
#line 230 "D:\\BWSI\\Exercises\\exercises\\QSharpExercises\\Lab7\\Lab7.qs"
                    Reset__.Apply(a);
                }
#line hidden
                catch
